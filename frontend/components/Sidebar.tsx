...
type NavItem = {
  ...
  href: string;
  icon: ReactNode;
  /** If set, link is shown only when user has at least view access. */
  module?: ModuleKey;
};
...
export default function Sidebar({ mobile = false, isOpen = false, onNavigate, onClose }: SidebarProps) {
  ...
  const moduleView: Record<ModuleKey, boolean> = {
    tasks: canViewTasks,
  ...
  const navItems: NavItem[] = [
    ...
    { name: tNav('tasks'), href: '/tasks', module: 'tasks', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>
    )},
    { name: tNav('projects'), href: '/projects', module: 'projects', icon: (
    ...
    { name: tNav('documents'), href: '/documents', module: 'documents', icon: (
    ...
    { name: tNav('contacts'), href: '/contacts', module: 'contacts', icon: (
    ...
    { name: tNav('companies'), href: '/companies', module: 'companies', icon: (
    ...
    { name: tNav('payments'), href: '/payments', module: 'payments', icon: (
    ...
    { name: tNav('cars'), href: '/cars', module: 'cars', icon: (
    ...
    { name: tNav('analytics'), href: '/analytics', module: 'analytics', icon: (
